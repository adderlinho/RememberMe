...
public class AlarmReceiverActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTitleView        = (TextView) findViewById(R.id.titleAlarm);
        mMessageView      = (TextView) findViewById(R.id.messageAlarm);
        ...
        if(intent != null)
        {
            ...
            mMessageView.setText(intent.getStringExtra("message"));
        }
