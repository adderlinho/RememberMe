...
public class RememberMeMonthlyActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remember_me_monthly);
...
//                startActivity(intentConfig);
        ...
        switch (v.getId()) {
            ...
            case R.id.reminder_create_button:
                ...
                else
                {
                    ...
                    setDataReminderOT(Settings.Secure.getString(RememberMeMonthlyActivity.this.getContentResolver(), Settings.Secure.ANDROID_ID),
    ...
    public void setDataReminderOT(final String user_phone_id, final String user_email, final String title, final String message, final String date, final String time) {
        ...
        Call<ReminderResponse> reminderOTResponseCall = endpointsApi.setDataReminder(user_phone_id, user_email, title, message, date, time, "monthly");
        reminderOTResponseCall.enqueue(new Callback<ReminderResponse>() {
            ...
            public void onResponse(Call<ReminderResponse> call, Response<ReminderResponse> response) {
                ...
                if(reminderResponse != null)
                {
                    ...
                    Intent intentAlarm = new Intent(RememberMeMonthlyActivity.this, AlarmReceiverActivity.class);
                    ...
                    pendingIntent = PendingIntent.getActivity(RememberMeMonthlyActivity.this, 0, intentAlarm, PendingIntent.FLAG_CANCEL_CURRENT);
                    ...
                    manager.setRepeating(AlarmManager.RTC_WAKEUP, calendar.getTimeInMillis(), AlarmManager.INTERVAL_DAY * Calendar.getInstance().getActualMaximum(calendar.DAY_OF_MONTH), pendingIntent);

                    Toast.makeText(RememberMeMonthlyActivity.this, getResources().getString(R.string.successfull_server_2), Toast.LENGTH_SHORT).show();
                    Intent intentMain = new Intent(RememberMeMonthlyActivity.this, MainActivity.class);
                ...
                {
                    Toast.makeText(RememberMeMonthlyActivity.this, getResources().getString(R.string.error_server_1), Toast.LENGTH_SHORT).show();
