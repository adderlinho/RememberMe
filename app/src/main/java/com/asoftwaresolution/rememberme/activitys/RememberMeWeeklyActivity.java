...
public class RememberMeWeeklyActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private RadioButton r_mon, r_tue, r_wed, r_thu, r_fri, r_sat, r_sun;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remember_me_weekly);
        ...
        r_mon           = (RadioButton) findViewById(R.id.radio_mon);
        r_tue           = (RadioButton) findViewById(R.id.radio_tue);
        r_wed           = (RadioButton) findViewById(R.id.radio_wed);
        r_thu           = (RadioButton) findViewById(R.id.radio_thu);
        r_fri           = (RadioButton) findViewById(R.id.radio_fri);
        r_sat           = (RadioButton) findViewById(R.id.radio_sat);
        r_sun           = (RadioButton) findViewById(R.id.radio_sun);
...
//                finish();
        ...
        switch (v.getId()) {
            ...
            case R.id.reminder_create_button:
                ...
                else
                {
                    ...
                    setDataReminderOT(Settings.Secure.getString(RememberMeWeeklyActivity.this.getContentResolver(), Settings.Secure.ANDROID_ID),
    ...
    public void setDataReminderOT(final String user_phone_id, final String user_email, final String title, final String message, final String time) {
        ...
        Call<ReminderResponse> reminderOTResponseCall = endpointsApi.setDataReminder(user_phone_id, user_email, title, message, "", time, "weekly");
        reminderOTResponseCall.enqueue(new Callback<ReminderResponse>() {
            ...
            public void onResponse(Call<ReminderResponse> call, Response<ReminderResponse> response) {
                ...
                if(reminderResponse != null)
                {
                    ...
                    Intent intentAlarm = new Intent(RememberMeWeeklyActivity.this, AlarmReceiverActivity.class);
                    intentAlarm.putExtra("title", mTitleView.getText().toString());
                    intentAlarm.putExtra("message", mMessageView.getText().toString());

                    pendingIntent = PendingIntent.getActivity(RememberMeWeeklyActivity.this, 0, intentAlarm, PendingIntent.FLAG_CANCEL_CURRENT);
                    ...
                    Toast.makeText(RememberMeWeeklyActivity.this, getResources().getString(R.string.successfull_server_2), Toast.LENGTH_SHORT).show();
                    Intent intentMain = new Intent(RememberMeWeeklyActivity.this, MainActivity.class);
                ...
                {
                    Toast.makeText(RememberMeWeeklyActivity.this, getResources().getString(R.string.error_server_1), Toast.LENGTH_SHORT).show();
