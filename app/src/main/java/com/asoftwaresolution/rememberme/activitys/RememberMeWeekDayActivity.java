...
public class RememberMeWeekDayActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remember_me_weekday);
...
//                finish();
        ...
        switch (v.getId()) {
            ...
            case R.id.reminder_create_button:
                ...
                else
                {
                    ...
                    setDataReminderOT(Settings.Secure.getString(RememberMeWeekDayActivity.this.getContentResolver(), Settings.Secure.ANDROID_ID),
    ...
    public void setDataReminderOT(final String user_phone_id, final String user_email, final String title, final String message, final String time) {
        ...
        Call<ReminderResponse> reminderOTResponseCall = endpointsApi.setDataReminder(user_phone_id, user_email, title, message, "", time, "weekday");
        reminderOTResponseCall.enqueue(new Callback<ReminderResponse>() {
            ...
            public void onResponse(Call<ReminderResponse> call, Response<ReminderResponse> response) {
                ...
                if(reminderResponse != null)
                {
                    ...
                    Intent intentAlarm = new Intent(RememberMeWeekDayActivity.this, AlarmReceiverActivity.class);
                    intentAlarm.putExtra("title", mTitleView.getText().toString());
                    intentAlarm.putExtra("message", mMessageView.getText().toString());

                    pendingIntent = PendingIntent.getActivity(RememberMeWeekDayActivity.this, 0, intentAlarm, PendingIntent.FLAG_CANCEL_CURRENT);
                    ...
                    Toast.makeText(RememberMeWeekDayActivity.this, getResources().getString(R.string.successfull_server_2), Toast.LENGTH_SHORT).show();
                    Intent intentMain = new Intent(RememberMeWeekDayActivity.this, MainActivity.class);
                ...
                {
                    Toast.makeText(RememberMeWeekDayActivity.this, getResources().getString(R.string.error_server_1), Toast.LENGTH_SHORT).show();
